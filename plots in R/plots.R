...
abline(lm(df$ALogP ~ df$MW)) # adding a Trend line
...
par(mfrow=c(2,2)) # This sets up a 2x2 plotting grid, meaning four plots will be arranged in two rows and two columns.
# Plot 1
# Plot 2
# Plot 3
# Plot 4
# Running plots in sequential order
par(mfrow=c(2,2),  mai = c(0.7, 0.7, 0.3, 0.3)) # In addition to defining a 2x2 grid, this adjusts the margin sizes using the mai parameter.
